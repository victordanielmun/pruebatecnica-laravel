                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:col-start-2 lg:justify-center">
                                <img
                                    src="https://unbcorp.cl/wp-content/uploads/2023/11/Logo_prueba_2-removebg-preview.png"
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                        ...
                                        >
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed">
                                                    CRUD con laravel, inertiajs,
                                                    react, taildwind para la
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Framework PHP: Laravel es un
                                            framework PHP de alto nivel,
                                            diseñado para crear aplicaciones web
                                            robustas y escalables de forma
                                            rápida, Ofrece una amplia gama de
                                            características, como enrutamiento,
                                            autenticación, autorización, bases
                                            de datos, plantillas, y más.
                                        </p>
                                    </div>
                                </a>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Biblioteca JavaScript: React es una
                                            biblioteca para crear interfaces de
                                            usuario interactivas usa componentes
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Tailwind CSS es un framework de
                                            utilidad que proporciona una gran
                                            cantidad de clases CSS predefinidas
